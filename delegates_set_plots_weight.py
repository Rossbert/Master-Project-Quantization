...
operation_mode = DelegatesUtils.OperationMode.weights
...
for layer in LAYERS:
    save_name = 'delegate_weight_acc_degradation_' + layer[:-1] + graph_params.extension
    ...
    for i, flip in enumerate(flips):
        ...
        axes.text(x = 0.5, y = 0.03, 
                  ...
                  fontsize = graph_params.fontsize)
        x_label = "Bit position disrupted"
    ...
    save_name = 'delegate_weight_acc_degradation_' + layer[:-1] + ".pdf"
